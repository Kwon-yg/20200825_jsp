	...
	<div class="container">
		...
		<!-- 내용 -->
			<div class="card">
				...
				<div class="card-body">
					<p class="card-title">홍길동 2020.08.27 13:10:15</p>
					<p class="card-text">
						동해 물과 백두산이 마르고 닳도록<br> 하느님이 보우하사 우리나라 만세.<br> 무궁화 삼천리 화려
						강산<br> 대한 사람, 대한으로 길이 보전하세.
					</p>
				</div>
				<div class="card-footer">
					<a href="/border/list.jsp" class="btn btn-primary">목록</a>
					<div class="float-right">
						<a href="/border/edit.jsp" class="btn btn-warning">수정</a>
